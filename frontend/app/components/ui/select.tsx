...
import { cn } from "@/lib/utils"; // Adjust this import for your utility functions.
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 min-w-[8rem] overflow-hidden rounded-md border border-gray-300 bg-white shadow-md animate-in fade-in-80",
        className
      )}
      {...props}
    >
