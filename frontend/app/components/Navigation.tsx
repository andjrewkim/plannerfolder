...
const Navigation: React.FC<NavigationProps> = ({ children, className, rightSidebarOpen = false }) => {
  ...
  const renderNavItems = () => {
    ...
    if (isLoadingAuth) {
      return (
        <Link href="/help" className="help-button" style={{ 
          display: 'flex', 
          alignItems: 'center',
    ...
    // If not authenticated (including auth error), show only help icon
    ...
    // Show all navigation items when authenticated (but no profile button)
    return (
      <>
        <Link href="/search" className="search-button" style={{ 
          display: 'flex', 
          alignItems: 'center',
          transition: 'transform 0.2s ease, opacity 0.2s ease',
          cursor: 'pointer'
        ...
        <Link href="/settings" className="settings-button" style={{ 
          display: 'flex', 
          alignItems: 'center',
          transition: 'transform 0.2s ease, opacity 0.2s ease',
          cursor: 'pointer'
    ...
    <div className={className}>
      ...
      <nav
        style={{
          position: 'fixed',
          top: '20px',
          right: rightSidebarOpen ? '339px' : '20px', // Adjust based on sidebar state
          display: 'flex',
          gap: '24px',
          alignItems: 'center',
          zIndex: 1000,
